...
export class InputManager {
  constructor(onGesture) {
    ...
    this._onPointer = () => this.onGesture?.();
  ...
  keyboardRaw() {
    ...
    // Convert screen-right only here. AI controllers already write physics steer.
    return {
  ...
  controls(vehicle = null, dt = 1 / 120) {
    ...
    // Analog channels remain direct while keyboard fills inactive channels.
    return {
